                ...
                <div className="relative z-10 grid gap-3 grid-cols-6">
                    <div className="col-span-full lg:col-span-2 overflow-hidden flex relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        <div className="size-fit m-auto relative">
                            ...
                            <h2 className="mt-6 text-center font-semibold text-gray-950 dark:text-white text-3xl">Private</h2>
                        </div>
                    </div>
                    <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        <div>
                            <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-secondary/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-secondary/5 before:rounded-full">
                            </div>
                            <div className="mt-6 text-center relative z-10 space-y-2">
                                ...
                                <p className="">Backed by Zero Knowledge Proofs, all bugs will remain private.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        <div>
                            ...
                            <div className="mt-14 text-center relative z-10 space-y-2">
                                ...
                                <p className="dark:text-gray-300 text-gray-700">Find all your bugs at lighting speed.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid sm:grid-cols-2">
                            ...
                            <div className="overflow-hidden relative mt-6 sm:mt-auto h-fit -mb-[34px] -mr-[34px] sm:ml-6 py-6 p-6 border rounded-tl-lg dark:bg-secondary/5 dark:border-white/10">
                                ...
                                <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <stop className="text-blue-500/20 dark:text-blue-500/50" stopColor="currentColor"></stop>
                                    <stop className="text-transparent" offset="1" stopColor="currentColor" stopOpacity="0.01"></stop>
                                    </linearGradient>
                                    </defs>
                                </svg>
                            </div>
