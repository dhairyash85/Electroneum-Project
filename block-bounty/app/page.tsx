  ...
  return (
    <div className="">
      ...
      <section className="text-center">
        <h1 className="text-4xl font-bold mb-4 text-white">Welcome to BlockBounty</h1>
      ...
      <section className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="bg-secondary">
          <CardHeader>
            <CardTitle>For Bounty Hunters</CardTitle>
          </CardHeader>
          <CardContent>
            <p>
              Discover bounties posted by companies and submit your secure bug reports using our
              state-of-the-art zk-SNARK verification system.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-secondary">
          ...
          <CardContent>
            <p>
              Post bug bounties and receive verified, confidential reports directly from expert
              researchers using blockchain technology.
            </p>
          </CardContent>
        </Card>
      </section>
          ...
          <div className="mx-auto px-6 max-w-6xl text-gray-500">
            <div className="relative">
              <div className="relative z-10 grid gap-3 grid-cols-6">
                <div className="col-span-full lg:col-span-2 overflow-hidden flex relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                ...
                <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div>
                    <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-secondary/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-secondary/5 before:rounded-full"></div>
                    <div className="mt-6 text-center relative z-10 space-y-2">
                      ...
                      <p className="">
                        Backed by Zero Knowledge Proofs, all bugs will remain
                        private.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-14 text-center relative z-10 space-y-2">
                      ...
                      <p className="dark:text-gray-300 text-gray-700">
                        Find all your bugs at lighting speed.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-span-full lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div className="grid sm:grid-cols-2">
                    <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                      <div className="relative aspect-square rounded-full size-12 flex border dark:bg-secondary/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-secondary/5 before:rounded-full"></div>
                    ...
                    <div className="overflow-hidden relative mt-6 sm:mt-auto h-fit -mb-[34px] -mr-[34px] sm:ml-6 py-6 p-6 border rounded-tl-lg dark:bg-secondary/5 dark:border-white/10">
                      <div className="absolute flex gap-1 top-2 left-3">
                        <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-secondary/10"></span>
                        <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-secondary/10"></span>
                        <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-secondary/10"></span>
                      </div>
                      <svg
                ...
                <div className="col-span-full lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-secondary border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div className="h-full grid sm:grid-cols-2">
                    <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                      <div className="relative aspect-square rounded-full size-12 flex border dark:bg-secondary/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-secondary/5 before:rounded-full">
                        <svg
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="dark:text-gray-300 text-gray-700">
                          Rid your platform of all the pesky bugs!
                        </p>
                      </div>
                    </div>
